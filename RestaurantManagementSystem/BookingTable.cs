...
namespace RestaurantManagementSystem
{
    public partial class BookingTable : Form
    {
        ...
        private void insertbttn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                con = new SqlConnection(@"Data Source=LAPTOP-F47L3111;Initial Catalog=NewRestaurantManagementSystem;Integrated Security=True");
                con.Open();
        ...
        private void BookingTable_Load(object sender, EventArgs e)
        {
